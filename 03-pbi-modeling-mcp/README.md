...
Exploración de las capacidades del [Power BI Modeling MCP Server](https://github.com/microsoft/powerbi-modeling-mcp) de Microsoft, conectado a un Semantic Model en Microsoft Fabric usando lenguaje natural desde VS Code.
...
├── README.md
├── setup/
│   ├── 01_claude_code.md          ← Configuración Claude Code (recomendado)
│   └── 02_github_copilot.md       ← Configuración GitHub Copilot
├── scenarios/
│   ├── 01_connect.md
│   ├── 02_relationships.md
│   ├── 03_descriptions.md
...
│   └── 08_rls.md
└── prompts/
    ├── prompts.md                 ← Todos los prompts validados (inglés)
    └── prompts_es.md              ← Todos los prompts validados (español)
```

El entorno compartido (Lakehouse, Semantic Model, datos) vive en [`environment/`](../environment/), un nivel arriba de esta sección.
...
👉 **Paso 1:** [Setup de Fabric](../environment/01_fabric_setup.md) (compartido con las otras secciones de este repositorio)

👉 **Paso 2 - Elige tu cliente:**
- [Claude Code](setup/01_claude_code.md)
- [GitHub Copilot](setup/02_github_copilot.md)
