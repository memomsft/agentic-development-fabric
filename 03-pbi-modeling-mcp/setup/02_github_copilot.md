...
2. Busca y selecciona: `MCP: Add Server`
3. Elige `HTTP`
4. Pega el endpoint: `https://api.fabric.microsoft.com/v1/mcp/powerbi`
5. Cuando pida un nombre, escribe: `powerbi-remote`
6. Completa el login que pida (cuenta de Microsoft Entra ID)

> ⚠️ El método manual (`MCP: Open User Configuration` + pegar el JSON del servidor a mano) puede fallar en la conexión. El comando guiado `MCP: Add Server` es el que funciona de forma consistente -- úsalo en vez del JSON manual.
